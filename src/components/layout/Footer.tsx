      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:py-20">
        <div className="grid grid-cols-2 gap-10 sm:grid-cols-3 lg:grid-cols-6">
            ...
            <div className="mt-5 flex items-center gap-2">
              {SOCIALS.map(({ icon: Icon, label }) => (
                <a
                  ...
                  href="#"
                  aria-label={label}
                  className="flex size-9 items-center justify-center rounded-full border border-white/15 text-slate-400 transition-all duration-200 hover:border-[#EC4899]/50 hover:bg-white/10 hover:text-white hover:shadow-[0_0_16px_rgba(236,72,153,0.35)]"
                >
          ...
          <div>
            ...
            <h4 className="mt-6 text-sm font-semibold text-white">Support</h4>
            <ul className="mt-4 space-y-2.5">
          ...
          <div className="col-span-2 sm:col-span-3 lg:col-span-1">
            ...
            <form onSubmit={handleSubscribe} className="mt-4 flex flex-col gap-2">
              <Input
                ...
                className="border-white/15 bg-white/5 text-white placeholder:text-slate-500 focus-visible:border-[#EC4899]/50 focus-visible:ring-[#EC4899]/30"
              />
              <Button
                type="submit"
