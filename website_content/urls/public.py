...
urlpatterns = [
    ...
    path("features/page/", FeaturesPagePublicView.as_view(), name="public-features-page"),
    path("order-card/", OrderCardPublicView.as_view(), name="public-order-card"),
