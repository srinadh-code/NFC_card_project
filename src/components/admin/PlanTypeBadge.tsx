...
// The NFC inventory's `card_type` (Wooden/Custom — Classic and Premium were
// retired and deleted) is a backend-fixed enum used across orders/products
// too. This is a display-layer mapping onto the public site's NEXORA plans
// (see NEXORA_CARD_TYPES in data/constants.ts, the source of truth), which
// now only lists Custom. "Wooden" has no NEXORA-plan equivalent (no plan
// maps to it), so it's shown as its own neutral label rather than force-fit
// into one — inventing that mapping isn't something the public site
// defines.
