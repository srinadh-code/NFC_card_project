...
import { valuesApi } from "@/lib/contentApi"
import type { Value } from "@/types/content"

export default function ValuesTab() {
  return (
    <ResourceListPage<Value>
      api={valuesApi}
      queryKey={["content", "values"]}
      resourceLabel="Value"
      ...
      createDefaults={(existing) => ({ icon: "Sparkles", title: "", description: "", display_order: existing.length, is_active: true })}
      columns={[
